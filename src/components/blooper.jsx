                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-gray-800 text-base font-medium">{task.text}</p>
                          <div className="flex items-center gap-1 mt-1 bg-indigo-50 w-fit px-2 py-0.5 rounded-md">
                            <span className="text-xs">🕐</span>
                            <span className="text-xs text-indigo-400 font-medium">{task.createdAt}</span>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                          <button
                            ...
                            className="bg-gray-100 hover:bg-gray-200 text-gray-600 px-3 py-2 rounded-md text-sm transition-colors"
                          >
                            Edit
                          </button>
                          <button
                      ...
                      {openIndex === index && task.description && (
